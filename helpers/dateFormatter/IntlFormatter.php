...
class IntlFormatter extends Configurable implements Formatter
{
    ...
    public function format($timestamp, $dateFormat, $timeFormat)
    {
        ...
        $datefmt = new IntlDateFormatter(
            $locale,
            $this->mapFormat($dateFormat),
            $this->mapFormat($timeFormat),
            $timezone
        );
    ...
    private function mapFormat($platformFormat)
    {
        $map = array(
            Formatter::FULL => IntlDateFormatter::FULL,
            Formatter::LONG => IntlDateFormatter::LONG,
            Formatter::MEDIUM => IntlDateFormatter::MEDIUM,
            Formatter::SHORT => IntlDateFormatter::SHORT,
            Formatter::NONE => IntlDateFormatter::NONE
        );
        return $map[$platformFormat];
    }
